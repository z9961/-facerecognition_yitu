...
<c:if test="${sessionScope.CheckFaceExist==0}">
	<!-- 获取list -->
	<jsp:forward page="/noimg.jsp"></jsp:forward>
</c:if>
<c:if test="${sessionScope.CheckFaceExist!=1}">
	<!-- 获取list -->
	<jsp:forward page="/CheckFaceExist"></jsp:forward>
</c:if>
